...
export const metricRegistry: MetricDefinition[] = [
  ...
  metric({ key: "usage_rate", label: "Usage Rate", shortLabel: "USG%", category: "Efficiency", description: "Share of team possessions used by a player.", formula: "(FGA + 0.44 * FTA + TOV) / Team Possessions", unit: "percentage", higherIsBetter: true, precision: 1, sourceType: "derived", requiresTracking: false, sampleQualifier: "Simplified MVP formula." }),
  metric({ key: "assist_rate", label: "Assist Rate", shortLabel: "AST%", category: "Efficiency", description: "Assists divided by teammate field goals while on court.", formula: "AST / Teammate FGM", unit: "percentage", higherIsBetter: true, precision: 1, sourceType: "derived", requiresTracking: false, sampleQualifier: "Estimated from seed context." }),
  ...
  metric({ key: "shot_quality", label: "Shot Quality", shortLabel: "SQ", category: "Shot Quality", description: "Expected points per shot.", formula: "Expected Points Per Shot", unit: "points", higherIsBetter: true, precision: 2, sourceType: "model", requiresTracking: false, sampleQualifier: "Transparent MVP model." }),
  ...
  metric({ key: "clutch_shot_quality", label: "Clutch Shot Quality", shortLabel: "Clutch SQ", category: "Shot Quality", description: "Expected points on clutch attempts.", formula: "Clutch Expected Points / Clutch Attempts", unit: "points", higherIsBetter: true, precision: 2, sourceType: "model", requiresTracking: false, sampleQualifier: "Tiny samples in demo data." }),
  ...
  metric({ key: "paint_touch_frequency", label: "Paint Touch Frequency", shortLabel: "Paint Touch", category: "Shot Profile", description: "Paint touches per touch.", formula: "Paint Touches / Touches", unit: "percentage", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic tracking proxy." }),
  ...
  metric({ key: "drives_per_75", label: "Drives Per 75", shortLabel: "Drives/75", category: "Creation", description: "Drives normalized to 75 possessions.", formula: "Drives / Possessions * 75", unit: "per75", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic tracking proxy." }),
  ...
  metric({ key: "rim_pressure_score", label: "Rim Pressure Score", shortLabel: "Rim Pressure", category: "Creation", description: "Composite of rim attempts, drives, free throws, and paint touches.", formula: "Weighted creation composite", unit: "number", higherIsBetter: true, precision: 1, sourceType: "derived", requiresTracking: true, sampleQualifier: "Demo composite." }),
  ...
  metric({ key: "passes_per_touch", label: "Passes Per Touch", shortLabel: "Pass/Touch", category: "Creation", description: "Pass volume normalized by touches.", formula: "Passes / Touches", unit: "number", higherIsBetter: true, precision: 2, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic tracking proxy." }),
  metric({ key: "points_created_by_assist", label: "Points Created By Assist", shortLabel: "PCA", category: "Creation", description: "Estimated points created through assists.", formula: "Assists * 2.35", unit: "points", higherIsBetter: true, precision: 1, sourceType: "derived", requiresTracking: false, sampleQualifier: "Estimated for demo." }),
  ...
  metric({ key: "opponent_expected_fg_pct", label: "Opponent Expected FG%", shortLabel: "Opp xFG%", category: "Defense", description: "Expected field goal percentage allowed.", formula: "Opponent xFG%", unit: "percentage", higherIsBetter: false, precision: 1, sourceType: "model", requiresTracking: true, sampleQualifier: "Synthetic matchup proxy." }),
  ...
  metric({ key: "rim_protection_value", label: "Rim Protection Value", shortLabel: "Rim Protect", category: "Defense", description: "Estimated points saved at the rim.", formula: "Rim xPTS Allowed - Actual Rim Points Allowed", unit: "points", higherIsBetter: true, precision: 1, sourceType: "model", requiresTracking: true, sampleQualifier: "Synthetic contest events." }),
  metric({ key: "contest_rate", label: "Contest Rate", shortLabel: "Contest%", category: "Defense", description: "Shot contests per defensive opportunity.", formula: "Contests / Defensive Possessions", unit: "percentage", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic contest events." }),
  metric({ key: "closeout_value", label: "Closeout Value", shortLabel: "Closeout", category: "Defense", description: "Estimated value from controlled closeouts.", formula: "Closeout Composite", unit: "number", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic tracking proxy." }),
  metric({ key: "matchup_difficulty", label: "Matchup Difficulty", shortLabel: "Difficulty", category: "Defense", description: "Average offensive quality of assignments.", formula: "Weighted opponent usage and skill", unit: "number", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic matchup proxy." }),
  ...
  metric({ key: "screen_navigation_score", label: "Screen Navigation Score", shortLabel: "Screen Nav", category: "Defense", description: "Demo proxy for navigating screens.", formula: "Contest and matchup composite", unit: "number", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic tracking proxy." }),

  metric({ key: "offensive_rebound_rate", label: "Offensive Rebound Rate", shortLabel: "OREB%", category: "Rebounding", description: "Offensive rebounds divided by rebound chances.", formula: "OREB / Rebound Chances", unit: "percentage", higherIsBetter: true, precision: 1, sourceType: "derived", requiresTracking: true, sampleQualifier: "Synthetic rebound chances." }),
  ...
  metric({ key: "contested_rebound_rate", label: "Contested Rebound Rate", shortLabel: "Cont Reb%", category: "Rebounding", description: "Share of rebounds that were contested.", formula: "Contested Rebounds / Rebounds", unit: "percentage", higherIsBetter: true, precision: 1, sourceType: "event", requiresTracking: false, sampleQualifier: "Synthetic rebound tags." }),
  metric({ key: "rebound_chances", label: "Rebound Chances", shortLabel: "Reb Ch", category: "Rebounding", description: "Estimated rebound chances.", formula: "Rebound Chances", unit: "number", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Per game display." }),
  ...
  metric({ key: "boxouts", label: "Boxouts", shortLabel: "Boxouts", category: "Rebounding", description: "Estimated boxout events.", formula: "Boxouts", unit: "number", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Per game display." }),
  metric({ key: "rebound_distance", label: "Rebound Distance", shortLabel: "Reb Dist", category: "Rebounding", description: "Average distance traveled to rebound.", formula: "Average rebound distance", unit: "number", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic rebound tracking." }),
  ...
  ...[
    ...
    ["distance_traveled", "Distance Traveled", "Distance", "Estimated distance traveled."],
    ...
    metric({ key, label, shortLabel, category: "Movement/Tracking", description, formula: "Synthetic tracking estimate", unit: "number", higherIsBetter: true, precision: 1, sourceType: "tracking", requiresTracking: true, sampleQualifier: "Synthetic tracking proxy." })
  ),
