...
export function TopNav() {
  return (
    <header className="border-b border-slate-200 bg-white text-ink shadow-sm">
          ...
          {coreNavLinks.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className="inline-flex min-h-9 shrink-0 items-center gap-2 rounded border border-transparent px-3 transition-colors hover:border-slate-200 hover:bg-slate-50"
              >
